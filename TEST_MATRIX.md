...
| P0-CU-03 | Pinned source official setup | `cd /tmp/hafiye-computer-use-linux.djXfCX/repo && ./install.sh` | Official source install/setup is the active P0 operation; final doctor pending | IN PROGRESS |
...
| P0-ENV-03 | Rust source build prerequisite | `cargo --version` before pinned setup | Command unavailable before the official source installer | SETUP PREREQUISITE |
